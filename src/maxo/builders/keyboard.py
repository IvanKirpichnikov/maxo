...
class KeyboardBuilder:
    ...
    def add_link(self, text: str, url: Omittable[str] = Omitted(), **kwargs: Any) -> Self:
        self.add(
            LinkKeyboardButton(
                text=text,
                url=url,
    ...
    def add_request_contact(self, text: str, **kwargs: Any) -> Self:
        self.add(
            RequestContactKeyboardButton(
                text=text,
            )
    ...
    def add_request_geo_location(self, text: str, quick: Omittable[bool] = Omitted(), **kwargs: Any) -> Self:
        self.add(
            RequestGeoLocationKeyboardButton(
                text=text,
                quick=quick,
